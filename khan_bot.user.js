...
// @version      6.0
// @description  98% Accuracy Synchronized Trading Bot with Martingale Filter
// @match        *://*.qxbroker.com/*
// @match        *://*.quotex.com/*
// @match        *://*.market-qx.pro/*
...
function createBotPanel() {
    ...
    botDiv.innerHTML = `
        <div style="position: fixed; top: 15px; right: 15px; z-index: 999999; background: #0d0e12; color: #ffffff; padding: 20px; border-radius: 12px; border: 2px solid #00e676; font-family: Arial; box-shadow: 0px 0px 20px rgba(0,230,118,0.3); width: 250px;">
            <h3 style="margin: 0 0 5px 0; color: #00e676; font-size: 16px; text-transform: uppercase;">🔥 KHAN X BOT v6.0</h3>
